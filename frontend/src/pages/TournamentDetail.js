...
const TournamentDetail = () => {
  ...
  return (
    <div className="page-container page-wrapper fade-in">
        ...
        <div className="fade-in">
            ...
            >
              <div>
                ...
                >
                  ...
                  {isCricket &&
                    " · NRR = Net Run Rate (Runs/Over scored − Runs/Over conceded)"}
                </p>
              </div>
              <div
                style={{
          ...
          >
            ...
            >
              ...
              <br />
              • Tiebreaker: Net Run Rate (NRR) = (Runs scored ÷ Overs faced) −
              (Runs conceded ÷ Overs bowled)
              <br />• Table updates automatically after each match result is
              entered
            </div>
          </div>
        </div>
      ...
      {/* FIXTURES TAB */}
      {/* FIXTURES TAB — Double Round Robin */}
      {activeTab === "fixtures" && (
        <div className="fade-in">
          <FixtureTab tournamentId={id} tournamentStatus={tournament.status} />
        </div>
      )}
                  ...
                  teams.map((t, i) => (
                    <tr key={t._id}>
                      ...
                      <td>
                        ...
                        {t.bracket === "champion" && (
                          <span className="badge badge-green">🏆 Champion</span>
                        )}
